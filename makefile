...
clean:
	rm -f $(SOURCE)-diff* $(SOURCE)-oldtmp*
...
$(TEXDIF_AUTOGEN).tex: $(RELATIVE_PATH)/settings.mk $(RELATIVE_PATH)/diffpreamble.tex
	latexdiff-vc $(TEXDIF_OPT) --git -r $(GIT_REV) $(SOURCE).tex > diff_latexdiff.log
